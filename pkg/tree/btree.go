...
func (p *btEpool) get(hit bool, i int, k interface{} /*K*/, q *d, t *Tree, ver int64) *Enumerator {
	x := p.Get().(*Enumerator)
	x.err, x.hit, x.i, x.k, x.q, x.t, x.ver = nil, hit, i, k, q, t, ver
	return x
}
...
type (
	...
	Tree struct {
		...
		cmp   Cmp
		first *d          //First leaf node pointer
		last  *d          //Last leaf node pointer
	...
	xe struct {
		...
		k       interface{} /*K*/
		lcp     []byte      //The longest common prefix for child nodes
...
// New returns a newly created, empty Tree. The Compare function is used
// for key collation.
func New(cmp Cmp) *Tree {
...
func (t *Tree) Seek(k interface{} /*K*/) (e *Enumerator, ok bool) {
	q := t.r
	if q == nil {
		e = btEPool.get(false, 0, k, nil, t, t.ver)
		return
	}
	...
	for {
		...
		if i, ok = t.find(q, k); ok {
			...
			case *x:
				...
				continue
			case *d:
				return btEPool.get(ok, i, k, x, t, t.ver), true
			}
		}
		...
		case *x:
			q = x.x[i].ch
		case *d:
			return btEPool.get(ok, i, k, x, t, t.ver), false
		}
	}
}
...
func (t *Tree) SeekFirst() (e *Enumerator, err error) {
	...
	return btEPool.get(true, 0, q.d[0].k, q, t, t.ver), nil
}
...
func (t *Tree) SeekLast() (e *Enumerator, err error) {
	...
	return btEPool.get(true, q.c-1, q.d[q.c-1].k, q, t, t.ver), nil
}
...
func (t *Tree) Put(k interface{} /*K*/, upd func(oldV interface{} /*V*/, exists bool) (newV interface{}, /*V*/
	write bool)) (oldV interface{} /*V*/, written bool) {
	pi := -1
	var p *x
	q := t.r
